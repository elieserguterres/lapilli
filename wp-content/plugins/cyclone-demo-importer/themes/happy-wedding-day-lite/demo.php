...
function cdi_import_files() {
    return array(
        array(
            ...
            'local_import_widget_file'     => CDI_PLUGIN_DIR_PATH . '/themes/happy-wedding-day-lite/inc/widgets.wie',
        ...
        array(
            ...
            'import_preview_image_url'   => CDI_PLUGIN_DIR_URL . '/assets/images/happy-wedding-day/gallery-1.jpg',
            'preview_url' => 'https://bizbergthemes.com/happy-wedding-day-pro/gallery-1/'
        ),
        array(
            'import_file_name'=> __('Homepage PRO','cdi'),
            'categories'      =>  array( 'PRO' , 'Pages' ),
            'import_preview_image_url'   => CDI_PLUGIN_DIR_URL . '/assets/images/happy-wedding-day/gallery-2.jpg',
            'preview_url' => 'https://bizbergthemes.com/happy-wedding-day-pro/gallery-2/'
        ),
        array(
            'import_file_name'=> __('Homepage PRO','cdi'),
            'categories'      =>  array( 'PRO' , 'Pages' ),
            'import_preview_image_url'   => CDI_PLUGIN_DIR_URL . '/assets/images/happy-wedding-day/contact-1.jpg',
            'preview_url' => 'https://bizbergthemes.com/happy-wedding-day-pro/contact-1/'
        ),
        array(
            'import_file_name'=> __('Homepage PRO','cdi'),
            'categories'      =>  array( 'PRO' , 'Pages' ),
            'import_preview_image_url'   => CDI_PLUGIN_DIR_URL . '/assets/images/happy-wedding-day/contact-2.jpg',
            'preview_url' => 'https://bizbergthemes.com/happy-wedding-day-pro/contact-2/'
        ),
    );
}
