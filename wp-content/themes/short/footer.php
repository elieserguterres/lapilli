 ...
 * @package Short
 */
$short_topcontact_content = get_theme_mod( 'short_topcontact_content');
?>
<!--==================== Short-FOOTER AREA ====================-->
<!-- Footer Section -->
...
<footer class="mt-copyright-area">
	<div class="container">	
		<div class="row">
			...
			<div class="site-info">
				<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'short' ) ); ?>">
					<?php
					/* translators: placeholder replaced with string */
					printf( esc_html__( 'Proudly powered by %s', 'short' ), 'WordPress' );
					?>
				</a>
				<span class="sep"> | </span>
				<?php
				/* translators: placeholder replaced with string */
				printf( esc_html__( 'Theme: %1$s by %2$s.', 'short' ), 'Short', '<a href="' . esc_url( __( 'https://themeansar.com/', 'short' ) ) . '" rel="designer">Themeansar</a>' );
				?>
